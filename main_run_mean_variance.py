...
task_id = 1
weight = 0.025
sample_path = Path("C:\ZenGardenInput\example_datasets\outputs_20260615-155409_fixed_cross_terms_1periods_with_operation\sample.pkl")
now = datetime.now()
...
sample_read_in = pd.read_pickle(sample_path)
